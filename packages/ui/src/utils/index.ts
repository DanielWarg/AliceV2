...
export const getGuardianStatusMessage = (status: string): string => {
  switch (status) {
    ...
    case 'brownout': return 'Using lighter processing for faster responses'
    case 'degraded': return 'Some features temporarily limited'
    case 'emergency': return 'System under high load'
    case 'lockdown': return 'Manual intervention required'
