...
def main():
    ...
    ap.add_argument("--model", required=True, help="weights dir containing manifest.json")
    ...
    with open(os.path.join(os.path.dirname(args.out), "ab_samples.jsonl"), "w", encoding="utf-8") as f:
        for s in samples[:50]:
