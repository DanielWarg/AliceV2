...
class RewardValidator:
    ...
    def validate_reward_components(self, reward_components: Dict[str, float]) -> Dict[str, Any]:
        """
        ...
        for component, value in reward_components.items():
            ...
            if not (bounds[0] <= value <= bounds[1]):
                ...
                validation["valid"] = False
                # Clip to bounds
                validation["corrected_values"][component] = np.clip(value, bounds[0], bounds[1])
    ...
    def winsorize_rewards(self, episodes: List[Dict[str, Any]], 
                         component: str = "total") -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
        """
    ...
    def establish_reward_policies(self, episodes: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
    ...
    def get_validation_summary(self) -> Dict[str, Any]:
        ...
        consistent_count = sum(1 for v in self.validation_history if v["mathematical_consistency"])
        ...
        return {
            ...
            "mathematical_consistency_rate": consistent_count / len(self.validation_history),
...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        episode = {
            "reward_components": {"total": total},
            "episode_id": i
        }
        test_episodes.append(episode)
    
    winsorized_episodes, win_stats = validator.winsorize_rewards(test_episodes, "total")
    print(f"Outliers clipped: {win_stats['outliers_clipped']} / {win_stats['original_count']}")
    print(f"Outlier rate: {win_stats['outlier_rate']:.2%}")
    print(f"Winsorization bounds: [{win_stats['bounds']['lower']:.3f}, {win_stats['bounds']['upper']:.3f}]")