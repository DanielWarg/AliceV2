    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        ...
        try:
            ...
            if total_hits > 0:
                ...
                print(
                    "⚠️  No memory chunks found (this might be expected for new index)"
                )
        ...
        forget_data = {"user_id": "test-user-123", "session_id": "test-session-456"}
        ...
        forget_all_data = {"user_id": "test-user-123"}
    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        ...
        for i in range(5):
            ...
            try:
                ...
                print(
                    f"  Stored memory {i+1}/5: {result.get('query_time_ms', 0):.1f}ms"
                )
            except Exception as e:
