...
def send_tool_request(client: httpx.Client, request: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        tools_mentioned = any(tool in response_text.lower() 
...
def run(rps: float = 2.0, seconds: int = 20) -> Dict[str, Any]:
    ...
    with httpx.Client(timeout=15.0) as client:
        while time.perf_counter() < end_time:
            ...
            if request_counter % 5 == 0:
                ...
                print(f"   Sent {request_counter} tool requests "
    ...
    result_summary = {
        ...
        "tool_detection_rate": tools_detected / total_requests if total_requests > 0 else 0,
    ...
    print(f"   Tools detected: {tools_detected}/{total_requests} "
