...
class EvalHarness:
    ...
    async def run_all_scenarios(self) -> List[Dict[str, Any]]:
        ...
        for i, scenario in enumerate(SCENARIOS, 1):
            logger.info(f"Running scenario {i}/{len(SCENARIOS)}", scenario_id=scenario["id"])
    ...
    def check_slo_compliance(self, results: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        planner_latencies = [r["p95_ms"] for r in results if r.get("route") == "planner"]
        ...
        slo_passed = (
            ...
            p95_micro <= max_p95_micro and
            p95_planner <= max_p95_planner and
            p95_deep <= max_p95_deep
        )
    ...
    def write_results(self, results: List[Dict[str, Any]], slo_check: Dict[str, Any]):
        ...
        logger.info("Results written", results_file=results_file, summary_file=summary_file)
...
async def main():
    ...
    try:
        ...
        # Logga resultat
        logger.info("Eval harness completed", 
