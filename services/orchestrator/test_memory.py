...
async def test_memory_service():
    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        ...
        try:
            ...
            response.raise_for_status()
            stats = response.json()
            print(f"✅ Stats retrieved: {stats['total_chunks']} chunks")
        except Exception as e:
        ...
        forget_data = {"user_id": user_id, "session_id": session_id}
        ...
        try:
            ...
            print(
                f"✅ Memory cleanup successful: {forget_result['deleted_count']} chunks deleted"
            )
        except Exception as e:
...
async def test_memory_performance():
    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        ...
        try:
            ...
            print(
                f"   Query performance: {result['query_time_ms']:.2f}ms (client: {query_time*1000:.2f}ms)"
            )
        except Exception as e:
