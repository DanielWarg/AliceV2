...
class RLOrchestrator:
    ...
    def process_turn(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        response = {
            ...
            "rl_info": {
                ...
                "canary": route_decision.get("canary", False)
                or tool_decision.get("canary", False),
            },
        }
    ...
    def _execute_turn(
        self, request: Dict[str, Any], route: str, tool: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    def _save_states(self) -> None:
        ...
        try:
            ...
            print(
                f"Turn {self.turn_count}: Saved RL states (route: {route_saved}, tools: {tool_saved})"
            )
...
if __name__ == "__main__":
    ...
    for i, request in enumerate(test_requests):
        ...
        print(
            f"Route: {response['route']} (canary: {response['rl_info']['route_decision']['canary']})"
        )
        print(
            f"Tool: {response['tool']} (canary: {response['rl_info']['tool_decision']['canary']})"
        )
