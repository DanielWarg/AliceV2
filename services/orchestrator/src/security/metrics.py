...
injection_suspected_total = Counter("alice_injection_suspected_total","Injection suspects")
tool_denied_total = Counter("alice_tool_denied_total","Tool denials", ["reason"])
high_risk_confirm_total = Counter("alice_high_risk_confirm_total","High-risk confirmations", ["decision"])
