...
class ProviderManager:
    ...
    def get_primary_provider(self) -> ProviderType:
        ...
        if (self.providers[ProviderType.OPENAI].enabled and 
            self.cloud_ok and 
            not self._is_circuit_open(ProviderType.OPENAI) and
            self.total_cost < self.cost_budget):
    ...
    def record_provider_failure(self, provider: ProviderType):
        ...
        logger.warning("Provider failure recorded", 
