...
class VoiceTools:
    ...
    async def tts_local(self, text: str, voice: str = "alice_neutral", speed: float = 1.0) -> Dict[str, Any]:
    ...
    async def social_benchmark(self, scenario: str = "werewolf_light", rounds: int = 5) -> Dict[str, Any]:
...
def get_voice_tools() -> Dict[str, Any]:
    ...
    return {
        "stt_local": {
            "schema": STT_TOOL_SCHEMA,
            "function": voice_tools.stt_local
        },
        "tts_local": {
            "schema": TTS_TOOL_SCHEMA,
            "function": voice_tools.tts_local
        },
        "social_benchmark": {
